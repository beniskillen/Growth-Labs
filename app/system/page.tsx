...
import { partners, services } from "../brand";
  ...
  return (
    <SiteFrame>
      <ValenceExperience
        ...
        trust={
          <TrustBar caption="COMPANIES BEN HAS WORKED AT AND WITH">
      ...
      <section className="section proof-section" id="work">
        <SectionHeading
          ...
          title={<>MTP Health. <em>The Category King proof.</em></>}
          copy="First Head of Growth seat: a named knee category, commercial systems underneath, and demand that pulled instead of being pushed."
        />
        <MtpCaseFeature />
      </section>
